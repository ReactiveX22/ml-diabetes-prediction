...
def run_demo():
    try:
        ...
        for name, model in models.items():
            ...
            print(
                f"        False Negative Rate: {fn_rate:.4f} ({cm[1,0]} missed diabetes cases)"
            )
        ...
        for i in range(len(X_sample)):
            ...
            if actual_label == "Diabetes" and predicted_label == "No Diabetes":
                print(f"    HIGH RISK: Missed diabetes case!")
            elif actual_label == "No Diabetes" and predicted_label == "Diabetes":
                print(f"    False alarm - requires follow-up test")
            print()
        ...
        print(
            f"Reason: Highest recall ({best_recall_value:.4f}) - minimizes missed diabetes cases"
        )
